$(document).ready(function () {
    ...
    if (localStorage.getItem("moonActive") === null)
        localStorage.setItem("moonActive", moonActive);
    if (localStorage.getItem("marsActive") === null)
    ...
    if (localStorage.getItem("grandchildActive") === null)
    ...
    if (localStorage.getItem("lifeActive") === null)
        localStorage.setItem("lifeActive", lifeActive);
    if (localStorage.getItem("swedishActive") === null)
    ...
    if (typeof (Storage) !== "undefined") {
        ...
        grandchildActive = localStorage.getItem("grandchildActive");
        goldActive = localStorage.getItem("goldActive");
        lifeActive = localStorage.getItem("lifeActive");
        swedishActive = localStorage.getItem("swedishActive");
        CDActive = localStorage.getItem("CDActive");
        offshoreActive = localStorage.getItem("offshoreActive");
        deepSeaActive = localStorage.getItem("deepSeaActive");
        secureActive = localStorage.getItem("secureActive");
        overflowActive = localStorage.getItem("overflowActive");
        armsDealActive = localStorage.getItem("armsDealActive");
        nuclearActive = localStorage.getItem("nuclearActive");
        relocationActive = localStorage.getItem("relocationActive");
        orbitalActive = localStorage.getItem("orbitalActive");
        voyageActive = localStorage.getItem("voyageActive");
        ...
        if (offshoreActive == "true") {
            offshoreActive = "false";
            localStorage.setItem("offshoreActive", offshoreActive);
            money += 100000;
            totalInvestment -= 100000;
            $('#totalInvestmentSpent').html('Money Spent on Investments: $' + totalInvestment.toFixed(2).replace(/(\d)(?=(\d{3})+\.)/g, "$1,").toString());
